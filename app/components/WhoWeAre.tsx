...
export const WhoWeAre = () => {
    ...
    return (
        <>
            <div className='mt-[100px] xl:mt-[50px] mdlap:mt-[136px] flex flex-wrap msm:flex-nowrap text-xs'>
                <span className={`py-[10px] w-[93px] border-b border-solid border-[#eddfd0] border-opacity-60 text-center ${activeTab === 'who' ? 'border-b-[4px]' : ''}`} onClick={() => setActiveTab('who')}>Who&nbsp;we&nbsp;are</span>
                <span className={`py-[10px] w-[93px] border-b border-solid border-[#eddfd0] border-opacity-60 text-center ${activeTab === 'mission' ? 'border-b-[4px]' : ''}`} onClick={() => setActiveTab('mission')}>Mission</span>
                <span className={`py-[10px] w-[83px] border-b border-solid border-[#eddfd0] border-opacity-60 text-center ${activeTab === 'vision' ? 'border-b-[4px]' : ''}`} onClick={() => setActiveTab('vision')}>Vision</span>
                <span className={`py-[10px] w-[103px] border-b border-solid border-[#eddfd0] border-opacity-60 text-center ${activeTab === 'meet' ? 'border-b-[4px]' : ''}`} onClick={() => setActiveTab('meet')}>Meet&nbsp;the&nbsp;team</span>
            </div>
            {/* Who we are */}
            {activeTab === 'who' && (
            <div className='mt-[47px] pb-[37px] w-full flex flex-wrap gap-[26px] text-xs border-b border-solid border-[#EDDFD0] border-opacity-50'>
            ...
            <div className='mt-[33px] mb-[33px] w-full flex flex-wrap gap-[25px] text-xs'>
                <div className='lg:w-[calc(50%-13px)]'>
